...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-svg-standard open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-svg-standard project authors
